...
and it has expanded into 75+ PRs. I was even given the chance to present some of my work on the OpenFaaS community call
...
* Updated a load of yaml for new K8s versions
